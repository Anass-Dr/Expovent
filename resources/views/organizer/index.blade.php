        ...
        <div class="row g-20">
            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6">
                <div class="expovent__count-item mb-20">
                    ...
                    <div class="expovent__count-content">
                        ...
                        <span class="expovent__count-text">Total Events</span>
                    </div>
            ...
            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6">
                <div class="expovent__count-item mb-20">
                    ...
                    ></div>
                    <div class="expovent__count-content">
                        <h3 class="expovent__count-number">{{ $app_reservations }}</h3>
                        <span class="expovent__count-text">Approved Reservations</span>
                    </div>
                    <div class="expovent__count-icon">
            ...
            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6">
                <div class="expovent__count-item mb-20">
                    ...
                    ></div>
                    <div class="expovent__count-content">
                        <h3 class="expovent__count-number">{{ $rej_reservations }}</h3>
                        <span class="expovent__count-text">Rejected Reservations</span>
                    </div>
                    <div class="expovent__count-icon">
            ...
            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6">
                <div class="expovent__count-item mb-20">
                    ...
                    ></div>
                    <div class="expovent__count-content">
                        <h3 class="expovent__count-number">{{ $pend_reservations }}</h3>
                        <span class="expovent__count-text">Pending Reservations</span>
                    </div>
                    <div class="expovent__count-icon">
