                            ...
                            <form action="{{ route('event.update', $event->id) }}" method="post">
                                ...
                                <div class="create__input-wrapper">
                                    ...
                                    <div class="singel__input-field mb-15">
                                        ...
                                        <input type="text" name="organization" value="{{ $event->organization }}" required />
                                    </div>
                                    <div class="singel__input-field mb-15">
                                ...
                                <div class="row g-20 mb-4">
                                    <div class="singel__input-field mb-15">
                                        <div class="singel__input-field is-color-change mb-15">
                                            ...
                                            <input type="date" name="starting_at" value="{{ $event->starting_at }}" required />
                                        </div>
                                    </div>
                                    <div class="singel__input-field mb-15">
                                        <div class="singel__input-field mb-15">
                                            <label class="input__field-text">Total Seat</label>
                                            <input type="number" name="places" value="{{ $event->places }}" required/>
                                        </div>
                                    </div>
                                    <div class="singel__input-field mb-15">
                                        <div class="singel__input-field mb-15">
                                    ...
                                    <div class="singel__input-field mb-15">
                                        ...
                                        <div class="contact__select">
                                            <select name="validation_type" value="{{ $event->validation_type }}" required>
