<x-guest-layout>
    ...
    <section id="homeindex" class="banner__area banner__area-1 banner__height-1 d-flex align-items-center" data-background="assets/img/bg/banner.png">
        ...
        <div class="banner__shape">
            <img class="banner__shape-1 parallaxed" src="assets/img/shape/slider/shape-1.png" alt="imge not found">
            <img class="banner__shape-2" src="assets/img/shape/slider/shape-2.png" alt="imge not found">
            <img class="banner__shape-3" src="assets/img/shape/slider/shape-3.png" alt="imge not found">
            <img class="banner__shape-4 parallaxed" src="assets/img/shape/slider/shape-4.png" alt="imge not found">
            <img class="banner__shape-5" src="assets/img/shape/slider/shape-5.png" alt="imge not found">
            <img class="banner__shape-6 parallaxed" src="assets/img/shape/slider/shape-6.png" alt="imge not found">
            ...
            <div class="row align-items-center">
                <div class="col-xxl-6 col-xl-6 col-lg-6">
                    <div class="about__content-wrapper mb-60">
                        ...
                        <a href="event-list.html" class="fill__btn">Join Now<i class="fa-regular fa-angle-right"></i></a>
                    </div>
                </div>
                <div class="col-xxl-6 col-xl-6 col-lg-6">
    ...
    <section class="join__area p-relative z-index-1 fix" data-background="assets/img/bg/joinbg.jpg">
        <div class="join__all-shape p-relative">
            <img class="join__shape-1" src="assets/img/shape/join-shape-1.png" alt="image not found">
            <img class="join__shape-2" src="assets/img/shape/join-shape-2.png" alt="image not found">
            <div class="container">
                ...
                <div class="speaker__slider-wrapper">
                    <div class="speaker__activation">
                        <div class="speaker__slider-item w-img">
                            <a href="#"><img src="assets/img/speaker/1.jpg" alt="image not found"></a>
                        </div>
                        <div class="speaker__slider-item w-img">
                            <a href="#"><img src="assets/img/speaker/2.jpg" alt="image not found"></a>
                        </div>
                        <div class="speaker__slider-item w-img">
                            <a href="#"><img src="assets/img/speaker/3.jpg" alt="image not found"></a>
                        </div>
                        <div class="speaker__slider-item w-img">
                            <a href="#"><img src="assets/img/speaker/4.jpg" alt="image not found"></a>
                        </div>
                        <div class="speaker__slider-item w-img">
                            <a href="#"><img src="assets/img/speaker/5.jpg" alt="image not found"></a>
                        </div>
                        <div class="speaker__slider-item w-img">
                            <a href="#"><img src="assets/img/speaker/1.jpg" alt="image not found"></a>
                        </div>
                            ...
                            <div class="tab-pane fade show active" id="nav-day-one" role="tabpanel" aria-labelledby="nav-day-one-tab" tabindex="0">
                                <div class="accordion" id="accordionExample">
                                    ...
                                    <span class="accordion__heading">
                                       <span class="accordion__meta">
                                          <span class="accordion__meta-thumb">
                                             <img src="assets/img/accordion/meta-02.png" alt="image not found">
                                          </span>
                                            ...
                                            <div class="accordion-body">
                                                <div class="accordiong__inner">
                                                    ...
                                                    <div class="accordion__thumb w-img">
                                                        <img src="assets/img/accordion/schedule-thumb.jpg" alt="image not found">
                                                    </div>
                                    ...
                                    <span class="accordion__heading">
                                       <span class="accordion__meta">
                                          <span class="accordion__meta-thumb">
                                             <img src="assets/img/accordion/meta-01.png" alt="image not found">
                                          </span>
                                          <span class="accordion__meta-contet">
                                    ...
                                    <span class="accordion__heading">
                                       <span class="accordion__meta">
                                          <span class="accordion__meta-thumb">
                                             <img src="assets/img/accordion/meta-03.png" alt="image not found">
                                          </span>
                                          <span class="accordion__meta-contet">
        ...
        <div class="tetimonial__inner-main p-relative">
            <div class="container p-relative">
                <div class="testimonial__all-user">
                    <img class="author__user-1 user__shadow" src="assets/img/testimonial/author/01.png" alt="image not found">
                    <img class="author__user-2 user__shadow" src="assets/img/testimonial/author/02.png" alt="image not found">
                    <img class="author__user-3 user__shadow" src="assets/img/testimonial/author/03.png" alt="image not found">
                    <img class="author__user-4 user__shadow" src="assets/img/testimonial/author/04.png" alt="image not found">
                    <img class="author__user-5 user__shadow" src="assets/img/testimonial/author/05.png" alt="image not found">
                    <img class="author__user-6 user__shadow" src="assets/img/testimonial/author/06.png" alt="image not found">
                    ...
                    <div class="col-xxl-8 col-xl-8 col-lg-8 text-center">
                        <div class="testimonial__activation">
                            ...
                            <div class="testimonial__item">
                                <div class="tetiminal-item-wrap">
                                    <div class="testimonial__thumb">
                                        <img src="assets/img/testimonial/5.png" alt="image not found">
                                        <div class="testimonial__quote">
                                            <i class="flaticon-quotation-1"></i>
                                        </div>
                                    </div>
    ...
    <div class="gallery__area fix">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="gallery-item">
                        <a href="assets/img/gallery/1.jpg" class="gallery-icon  popup-image"><i class="flaticon-plus"></i></a>
                        <img src="assets/img/gallery/1.jpg" alt="image not found">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="gallery-item">
                        <a href="assets/img/gallery/2.jpg" class="gallery-icon  popup-image"><i class="flaticon-plus"></i></a>
                        <img src="assets/img/gallery/2.jpg" alt="image not found">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="gallery-item">
                        <a href="assets/img/gallery/3.jpg" class="gallery-icon  popup-image"><i class="flaticon-plus"></i></a>
                        <img src="assets/img/gallery/3.jpg" alt="image not found">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="gallery-item">
                        <a href="assets/img/gallery/4.jpg" class="gallery-icon  popup-image"><i class="flaticon-plus"></i></a>
        ...
        <div class="gallery-wrap swiper-container gallery-slider-activation2">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="gallery-item">
                        <a href="assets/img/gallery/5.jpg" class="gallery-icon  popup-image"><i class="flaticon-plus"></i></a>
                        <img src="assets/img/gallery/5.jpg" alt="image not found">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="gallery-item">
                        <a href="assets/img/gallery/6.jpg" class="gallery-icon  popup-image"><i class="flaticon-plus"></i></a>
                        <img src="assets/img/gallery/6.jpg" alt="image not found">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="gallery-item">
                        <a href="assets/img/gallery/7.jpg" class="gallery-icon  popup-image"><i class="flaticon-plus"></i></a>
                        <img src="assets/img/gallery/7.jpg" alt="image not found">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="gallery-item">
                        <a href="assets/img/gallery/8.jpg" class="gallery-icon  popup-image"><i class="flaticon-plus"></i></a>
                        <img src="assets/img/gallery/8.jpg" alt="image not found">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="gallery-item">
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                    <div class="pricing__item mb-30">
                        ...
                        <div class="pricing__btn-wrap">
                            <a class="pricing__btn" href="signup.html">Register Now</a>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                    ...
                    <div class="partner__grid-wrapper">
                        <div class="partner__item">
                            <div class="partner__thumb">
                                <a href="#">
                                    <img src="assets/img/partner/1/01.png" alt="image not found">
                                </a>
                            </div>
                        </div>
                        <div class="partner__item">
                            <div class="partner__thumb">
                                <a href="#">
                                    <img src="assets/img/partner/1/02.png" alt="image not found">
                                </a>
                            </div>
                        </div>
                        <div class="partner__item">
                            <div class="partner__thumb">
                                <a href="#">
                                    <img src="assets/img/partner/1/03.png" alt="image not found">
                                </a>
                            </div>
                        </div>
                        <div class="partner__item">
                            <div class="partner__thumb">
                                <a href="#">
                                    <img src="assets/img/partner/1/04.png" alt="image not found">
                                </a>
                            </div>
                        </div>
                        <div class="partner__item">
                            <div class="partner__thumb">
                                <a href="#">
                                    <img src="assets/img/partner/1/05.png" alt="image not found">
                                </a>
                            </div>
                        </div>
                        <div class="partner__item">
                            <div class="partner__thumb">
                                <a href="#">
                                    <img src="assets/img/partner/1/06.png" alt="image not found">
                                </a>
                            </div>
                        </div>
                        <div class="partner__item">
                            <div class="partner__thumb">
                                <a href="#">
                                    <img src="assets/img/partner/1/07.png" alt="image not found">
                                </a>
                            </div>
                        </div>
                        <div class="partner__item">
                            <div class="partner__thumb">
                                <a href="#">
                                    <img src="assets/img/partner/1/08.png" alt="image not found">
                                </a>
                            </div>
                        </div>
                        <div class="partner__item">
                            <div class="partner__thumb">
                                <a href="#">
                                    <img src="assets/img/partner/1/09.png" alt="image not found">
                                </a>
                            </div>
                        </div>
                        <div class="partner__item">
                            <div class="partner__thumb">
                                <a href="#">
                                    <img src="assets/img/partner/1/10.png" alt="image not found">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="swiper-wrapper">
                            ...
                            <div class="blog__item-wrapper">
                                <div class="blog__item mb-30">
                                    <div class="blog__thumb w-img">
                                        <a href="schedule-list.html">
                                            <img src="assets/img/blog/1/01.jpg" alt="image not found">
                                        </a>
                                    </div>
                                    <div class="blog__content">
                                        <h3>
                                            <a href="schedule-list.html">How to get started learning JavaScript the right way
                                            </a>
                                        </h3>
                                    </div>
                              ...
                              <span>
                                 ...
                                 <a href="#">0 Comments</a>
                                    ...
                                    <a class="blog__btn" href="schedule-list.html">business</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="blog__item mb-30">
                            <div class="blog__thumb w-img">
                                <a href="schedule-list.html">
                                    <img src="assets/img/blog/1/02.jpg" alt="image not found">
                                </a>
                            </div>
                            <div class="blog__content">
                                <h3>
                    ...
                    <div class="swiper-slide">
                        <div class="blog__item mb-30">
                            <div class="blog__thumb w-img">
                                <a href="schedule-list.html">
                                    <img src="assets/img/blog/1/03.jpg" alt="image not found">
                                </a>
                            </div>
                            <div class="blog__content">
                                <h3>
