...
<!-- Mirrored from codeskdhaka.com/html/expovent-prev/expovent/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Mar 2024 17:30:52 GMT -->
...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/xea37h8ryf0jvizl0xrodeakz4w5rymumc47e6xaq26qzocy/tinymce/6/tinymce.min.js"
...
<body class="body-area">
            ...
            <div class="popup__input-wrapper">
                <form action="#">
                    ...
                    <button class="input__btn w-100" type="submit">
                        <i class="fa-regular fa-plus"></i>Add Speaker
                    </button>
                </form>
            </div>
        </div>
    ...
    <div class="page__full-wrapper">
        ...
        <div class="expovent__sidebar" data-background="{{ asset('assets/img/bg/dropdown-bg.png') }}">
            <div class="logo-details">
                <span>
                    <a href="dashboard.html">
                        <img class="logo__white" src="{{ asset('assets/img/logo/logo-small.svg') }}"
                            alt="logo not found" />
                    </a>
                </span>
                <span>
                    <a href="dashboard.html">
                        <img class="log__smnall" src="{{ asset('assets/img/logo/logo.svg') }}"
                            alt="logo not found" />
                    </a>
                </span>
            </div>
                                        ...
                                        <div class="email__dropdown">
                                            <div class="notification__card card__scroll">
                                                ...
                                                <div class="notification__item">
                                                    <div class="notification__thumb">
                                                        <a href="profile.html"><img
                                                                src="{{ asset('assets/img/user/notifactuion/02.png') }}"
                                                                alt="image not found" /></a>
                                                    </div>
                                                    <div class="notification__content">
                                                        <p>
                                                            <a href="chat.html">consectetur adipisci elit, sed
                                                                eiusmod</a>
                                                        </p>
                                                ...
                                                <div class="notification__item">
                                                    <div class="notification__thumb">
                                                        <a href="profile.html"><img
                                                                src="{{ asset('assets/img/user/notifactuion/01.png') }}"
                                                                alt="image not found" /></a>
                                                    </div>
                                                    <div class="notification__content">
                                                        <p>
                                                ...
                                                <div class="notification__item">
                                                    <div class="notification__thumb">
                                                        <a href="profile.html"><img
                                                                src="{{ asset('assets/img/user/notifactuion/03.png') }}"
                                                                alt="image not found" /></a>
                                                    </div>
                                                    <div class="notification__content">
                                                        <p>
                                                ...
                                                <div class="notification__item">
                                                    <div class="notification__thumb">
                                                        <a href="profile.html"><img
                                                                src="{{ asset('assets/img/user/notifactuion/04.png') }}"
                                                                alt="image not found" /></a>
                                                    </div>
                                                    <div class="notification__content">
                                                        <p>
                                        ...
                                        <div class="notification__dropdown">
                                            <div class="notification__card card__scroll">
                                                ...
                                                <div class="notification__item">
                                                    <div class="notification__thumb">
                                                        <a href="profile.html"><img
                                                                src="{{ asset('assets/img/meta/chatbox/01.png') }}"
                                                                alt="image not found" /></a>
                                                    </div>
                                                    <div class="notification__content">
                                                        <p>
                                                            Mark your calendar for BITPA Conference Dhaka
                                                            Meet up 2023
                                                        </p>
                                                        <div class="notification__time">
                                                            <span>2h ago</span>
                                                ...
                                                <div class="notification__item">
                                                    <div class="notification__thumb">
                                                        <a href="profile.html"><img
                                                                src="{{ asset('assets/img/meta/chatbox/02.png') }}"
                                                                alt="image not found" /></a>
                                                    </div>
                                                    <div class="notification__content">
                                                        <p>
                                                            Get ready for today’s Business Conference Tokyo
                                                            Meet up - 2023!
                                                        </p>
                                                        <div class="notification__time">
                                                            <span>2h ago</span>
                                                ...
                                                <div class="notification__item">
                                                    <div class="notification__thumb">
                                                        <a href="profile.html"><img
                                                                src="{{ asset('assets/img/meta/chatbox/03.png') }}"
                                                                alt="image not found" /></a>
                                                    </div>
                                                    <div class="notification__content">
                                                        <p>
                                                            You don’t want to miss Digital Innovation Meet
                                                            up!
                                                        </p>
                                                        <div class="notification__time">
                                                            <span>2h ago</span>
                                                ...
                                                <div class="notification__item">
                                                    <div class="notification__thumb">
                                                        <a href="profile.html"><img
                                                                src="{{ asset('assets/img/meta/chatbox/04.png') }}"
                                                                alt="image not found" /></a>
                                                    </div>
                                                    <div class="notification__content">
                                                        <p>
                                                            Digital Innovation Meet up Canada - 2023 starts
                                                            in 5 minutes!
                                                        </p>
                                                        <div class="notification__time">
                                                            <span>2h ago</span>
                                                ...
                                                <div class="notification__item">
                                                    <div class="notification__thumb">
                                                        <a href="profile.html"><img
                                                                src="{{ asset('assets/img/meta/chatbox/05.png') }}"
                                                                alt="image not found" /></a>
                                                    </div>
                                                    <div class="notification__content">
                                                        <p>
                                                ...
                                                <div class="notification__item">
                                                    <div class="notification__thumb">
                                                        <a href="profile.html"><img
                                                                src="{{ asset('assets/img/meta/chatbox/06.png') }}"
                                                                alt="image not found" /></a>
                                                    </div>
                                                    <div class="notification__content">
                                                        <p>
                                                ...
                                                <div class="notification__item">
                                                    <div class="notification__thumb">
                                                        <a href="profile.html"><img
                                                                src="{{ asset('assets/img/meta/chatbox/07.png') }}"
                                                                alt="image not found" /></a>
                                                    </div>
                                                    <div class="notification__content">
                                                        <p>
                                                ...
                                                <div class="notification__item">
                                                    <div class="notification__thumb">
                                                        <a href="profile.html"><img
                                                                src="{{ asset('assets/img/meta/chatbox/08.png') }}"
                                                                alt="image not found" /></a>
                                                    </div>
                                                    <div class="notification__content">
                                                        <p>
                                                            Meet the speakers at Cyber Security Conference
                                                            Meet up Japan!
                                                        </p>
                                                        <div class="notification__time">
                                                            <span>2h ago</span>
