                            ...
                            <div class="event__venue-card mb-20">
                                <div class="event__venue-inner">
                                    <div class="event__venue-content">
                                        ...
                                        <h4 class="event__venue-title">{{ $event->title }}</h4>
                                        <p>{{ $event->address }}</p>
                                    </div>
                                    <div class="event__venue-thumb">
                                        ...
                                        <div class="event__tag-post">
                                            <div class="event__tag-item">
                                                <span><a href="{{ route('event__user.show', $event->title) }}">{{ $event->places }} Seat Available</a></span>
                                            </div>
                                            <div class="event__tag-item">
                                                <span>Validation {{ $event->validation_type }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
