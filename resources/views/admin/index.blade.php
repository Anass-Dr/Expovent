        ...
        <div class="row g-20">
            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6">
                <div class="expovent__count-item mb-20">
                    <div
                        class="expovent__count-thumb include__bg transition-3"
                        data-background="assets/img/bg/count-bg.png"
                    ></div>
                    <div class="expovent__count-content">
                        <h3 class="expovent__count-number">{{ $users }}</h3>
                        <span class="expovent__count-text">Total Users</span>
                    </div>
            ...
            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6">
                <div class="expovent__count-item mb-20">
                    ...
                    ></div>
                    <div class="expovent__count-content">
                        <h3 class="expovent__count-number">{{ $app_events }}</h3>
                        <span class="expovent__count-text">Approved Events</span>
                    </div>
                    <div class="expovent__count-icon">
            ...
            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6">
                <div class="expovent__count-item mb-20">
                    ...
                    ></div>
                    <div class="expovent__count-content">
                        <h3 class="expovent__count-number">{{ $rej_events }}</h3>
                        <span class="expovent__count-text">Rejected Events</span>
                    </div>
                    <div class="expovent__count-icon">
            ...
            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6">
                <div class="expovent__count-item mb-20">
                    ...
                    ></div>
                    <div class="expovent__count-content">
                        <h3 class="expovent__count-number">{{ $categories }}</h3>
                        <span class="expovent__count-text">Total Categories</span>
                    </div>
                    <div class="expovent__count-icon">
                        <i class="flaticon-reminder"></i>
                    </div>
            ...
            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6">
                <div class="expovent__count-item mb-20">
                    ...
                    ></div>
                    <div class="expovent__count-content">
                        <h3 class="expovent__count-number">{{ $reservations }}</h3>
                        <span class="expovent__count-text">Total Reservations</span>
                    </div>
                    <div class="expovent__count-icon">
                                ...
                                <div class="card__header-dropdown">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-list">
                                            <a class="dropdown__item" href="javascript:void(0)"
                                            >Edit</a
                                            >
                                            <a class="dropdown__item" href="javascript:void(0)"
                                            >Delete</a
