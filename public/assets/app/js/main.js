...
MagnificPopup image view
    ...
    /*======================================
	Category popup-active js
	========================================*/

	$(".category__popup-active").on("click", function (e) {
        const categoryName = e.currentTarget.closest('tr').querySelector('td:nth-of-type(2) span').textContent;
        const categoryId = e.currentTarget.closest('tr').querySelector('td:nth-of-type(1) span').textContent;
		$(".category__popup-area").addClass("open");
        $(".category__popup-area input[name='name']").val(categoryName);
        const action = $(".category__popup-area form").attr('action');
        action.replace('1', categoryId);
        $(".category__popup-area form").attr('action', action);
		$(".offcanvas__overlay").addClass("overlay-open");

	});
	$(".offcanvas__overlay").on("click", function () {
		$(".category__popup-area").removeClass("open");
		$(".offcanvas__overlay").removeClass("overlay-open");

	});

    /*======================================
	Event Validate popup-active js
	========================================*/

	$(".validate-event__popup-active").on("click", function (e) {
        const eventId = e.currentTarget.closest('tr').querySelector('input[type="hidden"]').value;
        const status = e.currentTarget.closest('tr').querySelector('td#status span').textContent;
        const title = e.currentTarget.closest('tr').querySelector('td#title span').textContent;
		$(".validate-event__popup-area").addClass("open");
        $(".validate-event__popup-area input[name='event_id']").val(eventId);
        $(".validate-event__popup-area input[name='title']").val(title);
        $(".validate-event__popup-area select").val(status);
		$(".offcanvas__overlay").addClass("overlay-open");
    ...
    /*======================================
	Edit Event popup-active js
	========================================*/

	$(".edit-event__popup-active").on("click", function (e) {
        const eventId = e.currentTarget.closest('tr').querySelector('input[type="hidden"]').value;
		$(".category__popup-area").addClass("open");
        $(".category__popup-area input[name='name']").val(categoryName);
        const action = $(".category__popup-area form").attr('action');
